<template>
  <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
    <a id="show-sidebar" @click="closeToggle" class="btn btn-sm btn-dark" href="#">
    ...
    <nav id="sidebar" class="sidebar-wrapper">
      <div class="sidebar-content">
        ...
        <div class="sidebar-item sidebar-brand">
          <a href="#">Vue Store</a>
          <div id="close-sidebar" @click="closeToggle">
      ...
      <div class="sidebar-footer">
        ...
        <div>
          <a href="#">
            <i class="fa fa-power-off" id="signout" @click="signOut"></i>
          </a>
        </div>
